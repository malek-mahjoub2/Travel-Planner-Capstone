...
import './ClientReviews.css'; // Create a CSS file for styling
...
const clientReviews = [
  ...
  },
  {
    ...
    image: Robin,
    review: 'This is our first time booking through Travel Planners we have found Paul extremley helpful and professional. Nothing was too much trouble',
  },
  {
    name: 'Alice Johnson',
    image: Harrison,
    review: 'This is my third time using travel planners to plan a holiday and Im always happy with the results! ',
  },
];
